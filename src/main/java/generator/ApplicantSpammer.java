            ...
            int finalI = i;
                new Thread(() -> {
                    try {
                        ...
                        String allnames = ApplicantIO.readFile(System.getProperty("user.dir") + "\\first-names.txt");
                        ...
                        //Image
                        Process powershellGetRandImage = Runtime.getRuntime().exec("powershell.exe Invoke-WebRequest https://thispersondoesnotexist.com/ -OutFile '" + directory + "'");
                        TimeUnit.SECONDS.sleep(number/5);
