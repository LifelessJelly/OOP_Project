...
public class StaffConsole extends JPanel{
    ...
    public StaffConsole(MainFrame main) {
        this.main=main;
        //this.op=op;
        ...
        gridBagLayout.columnWidths = new int[]{62, 71, 71, 71, 71, 71, 71, 71, 71};
    ...
    public void replacePanel(JPanel container,JPanel replacement){
