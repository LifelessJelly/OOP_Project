...
public class HRbuttons extends JPanel{
    ...
    public HRbuttons() {
        ...
        JPanelImageButton btnOption1 = new JPanelImageButton("edit profile",miau,miau,60,60,3);
        add(btnOption1);

        JPanelImageButton btnOption2 = new JPanelImageButton("generate list",miau,miau,60,60,3);
        add(btnOption2);

        JPanelImageButton btnOption3 = new JPanelImageButton("save details",miau,miau,60,60,3);
        add(btnOption3);
        ...
        btnOption1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                lblStatus.setText("Profile edited!");
            }
        });
