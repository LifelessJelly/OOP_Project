...
public class Console extends JPanel {
    ...
    private ShortlistOrAcceptPage shortlistOrAcceptPage;
    ...
    public Console(InfobaseMainframe main){
        ...
        String jobRole = "";
        if (main.getController().getUser().authorised(1)){
            jobRole = "(Manager)";
        }
        else if (main.getController().getUser().authorised(2)){
            jobRole = "(HR)";
        }
        ...
        JPanelImageButton viewApplicantButton = new JPanelImageButton("View Applicants", miau, miau, 60, 60, JPanelImageButton.BOTTOM);
        ...
        if (main.getController().getUser().authorised(Staff.MANAGER)) {
            JPanelImageButton shortlistApplicantsButton = new JPanelImageButton("Shortlist Applicants", miau, miau, 60, 60, JPanelImageButton.BOTTOM);
            ...
            shortlistApplicantsButton.addActionListener(e -> {
                showShortlistApplicantPage();
            });
        }

        if (main.getController().getUser().authorised(Staff.MANAGER)){
            JPanelImageButton viewSummaryButton = new JPanelImageButton("View Summary", miau, miau, 60, 60, JPanelImageButton.BOTTOM);
        ...
        JPanelImageButton settingsButton = new JPanelImageButton("Settings", miau, miau, 60, 60, JPanelImageButton.BOTTOM);
    ...
    public void showShortlistApplicantPage(){
        if (!(main.getContentPane().getComponent(main.getComponentCount()-1) instanceof ShortlistOrAcceptPage)) {
            shortlistOrAcceptPage = new ShortlistOrAcceptPage(main);
