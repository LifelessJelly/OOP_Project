...
public class Console extends JPanel {
    ...
    private void initComponents() {
        ...
        viewApplicantButton = new JPanelImageButton("View Applicants", ImageEmbedded.ViewApplicantsIcon.VIEWAPPLICANTS_OFF, ImageBase64.imageToBase64(main.getImage("ViewApplicantsIcon")), 60, 60, JPanelImageButton.BOTTOM);
        ...
        viewSummaryButton = new JPanelImageButton("View Summary", ImageEmbedded.ViewSummaryIcon.VIEWSUMMARY_OFF, ImageBase64.imageToBase64(main.getImage("ViewSummaryIcon")), 60, 60, JPanelImageButton.BOTTOM);
